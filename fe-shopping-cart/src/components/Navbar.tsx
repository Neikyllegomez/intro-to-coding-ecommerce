...
export function Navbar() {
    ...
    return (
    <NavBarBs sticky="top" className=' shadow-1 mb-3'>
        <Container>
            <Nav>
            ...
            <div className='rounded-circle bg-danger d-flex justify-content-center align-items-center' style={{color: 'white', width: "1.5rem", height :"1.5rem", position: 'absolute', top: 0, right: 0, transform: "translate(25%, -25%)"}}>{cartQuantity}</div>
            </Button>
        </Container>
    </NavBarBs>)
}