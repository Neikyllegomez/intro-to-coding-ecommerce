...
export function StoreItem({id, name, price, image} : StoreItemProps) {
    ...
    <Card className="h-auto">
        <Card.Img variant="top" src={image} height="400px" style={{objectFit: "cover"}}></Card.Img>
        <Card.Body className="d-flex flex-column">
            ...
            <div className="mt-auto">
                {quantity === 0 ? (
                    <Button className='w-100 outline-danger' variant="danger" onClick={() => dispatch(increaseCartQuantity(id))}>+ Add to Cart</Button>
